...
ROOT_DIR=/home/lt/liuteng/my_dataset
...
if [ "${EXP}" = "." ]; then
    NUM_LABELS=2
   # when train
   #  DATA_ROOT=${ROOT_DIR}/multitask/training/
   #  DATA_ROOT=${ROOT_DIR}/eyeskuochong/
   #  DATA_ROOT=${ROOT_DIR}/ophtha_ex/
   #  DATA_ROOT=${ROOT_DIR}/isbi/
   #   DATA_ROOT=${ROOT_DIR}/44/
      DATA_ROOT=${ROOT_DIR}/isbi_ex/
   # when test
   #  DATA_ROOT=${ROOT_DIR}/multitask/testing/
   #   DATA_ROOT=${ROOT_DIR}/ophtha_ex/
else
    NUM_LABELS=0
    echo "Wrong exp name"
...
if [ ${RUN_TRAIN} -eq 1 ]; then
    ...
    #MODEL=${EXP}/model/${NET_ID}/train_iter_200000.caffemodel
    #
